...
public abstract class FiguresFragment extends Fragment {
  ...
  FigureItemListener figureItemListener = new FigureItemListener() {
    @Override public void onFigureItemClick(View view, Item figureItem) {
  ...
  static class FigureAdapter extends RecyclerView.Adapter<FigureAdapter.ViewHolder> {
    ...
    @Override public FigureAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
      // create a new view
    ...
    @Override public void onBindViewHolder(final ViewHolder holder, int position) {
      ...
      Glide.with(holder.imageViewFigure.getContext())
          .load(url)
          //.override(200, 200)
          //.centerCrop()
          .fitCenter()
